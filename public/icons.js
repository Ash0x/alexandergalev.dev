export const SunIcon = () => {
	return (
		<svg
			...
			strokeWidth='1.5'
			stroke='currentColor'
			className='m-1 w-6 h-6 text-slate-900 hover:text-amber-500'
		>
			<path
				strokeLinecap='round'
...
export const MoonIcon = () => {
	return (
		<svg
			...
			strokeWidth='1.5'
			stroke='currentColor'
			className='m-1 w-6 h-6 dark:hover:text-white'
		>
			<path
				strokeLinecap='round'
				strokeLinejoin='round'
...
export const devIcons = [
	{ iconName: 'devicon-html5-plain', title: 'HTML' },
	{ iconName: 'devicon-css3-plain', title: 'CSS' },
	{ iconName: 'devicon-javascript-plain', title: 'JavaScript' },
	{ iconName: 'devicon-typescript-original', title: 'TypeScript' },
